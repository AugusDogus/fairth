...
viewer_password="${ANDROID_VIEWER_PASSWORD:?ANDROID_VIEWER_PASSWORD is required}"
...
printf '%s\n' \
  ...
  "Open ${public_url}" \
  'Enter ANDROID_VIEWER_PASSWORD when prompted. Keep this private HTTP service on a trusted LAN or tailnet.'
